...
function receni() {
  ...
  let novaRecenica1 = "";
  let novaRecenica2 = recen.length / 2;
  novaRecenica1 += recen.toUpperCase();
  novaRecenica1 += recen.toLowerCase();
  if (novaRecenica1 === novaRecenica2) {
    novaRecenica1 += recen.toUpperCase() + recen.toLowerCase();
  }
  novaRecenica1 += recen.replace(/skola/g, "fakultet");
