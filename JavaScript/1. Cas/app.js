console.log("Prvi cas javaskripta");
...
// Za proveru tipa odredjene promenjive (varijable) se koristi typeof operator.
...
console.log(BigInt(345353465476455234324234));
console.log(typeof BigInt(345353465476455234324234));
...
// 2. Object (objekat) - Struktura podataka za skladistenje vise vrednosti (te vrednsoti mogu biti razlicitog tipa).
...
// 3. Set - Struktura podataka za skladistenje vise vrednosti koja ne dozvoljava duplikate. Slicna je nizu
// (Array), a sintaksa za pravljenje seta je:
set = new Set(["Asija", "Melida", "Dino", 19, 31, 25, "Dino"]); // Svako novo pojavljivanje elementa u setu se nece primeniti.
console.log(set); // new se posmatra kao objekat
