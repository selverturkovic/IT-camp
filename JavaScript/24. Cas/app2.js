...
console.log(x);
let y = 123e-5; //0.00123  123/100000
console.log(y);

console.log("100" / "10"); // 10
console.log("10n0" / "10"); // NaN
...
NaN; // je number tipa. Ali nije korektan broj.

// Infinity (-Infinity) je vrednost u JavaScriptu koja prelazi najveci (najmanji)
// dozvoljeni broj.
...
console.log(z + 2);
// numbers i number objects ne mogu biti jednaki (zbog razlicitog tipa).
let w = 123;
