// JavaScript GET metode:

// Sledece metode mozemo iskoristiti za dobijanje
// odredjenih informacija vezano za neki datum:
...
console.log(date.getDay()); // vraca vrednost 0-6 (dani u nedelji) ukljucujuci oba
// 0 - nedelja
// 6 - subota

// 10. Date.now()

console.log(Date.now()); // broj milisekundi od 1.1.1970 do sada
...
const niz = [1, 2, 3];
console.log(niz);
const drugiNiz = niz; // nismo uzeli vrednost vec referencu. Svaka promena se odnosi i za drugiNiz i za niz
