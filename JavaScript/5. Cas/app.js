...
// Posto je vrednost dobijena preko prompt metode uvek string, otuda potreba da
// pretvorimo taj string u number tip podatka.
...
console.log(Number("")); // rezultat je 0
