...
const myCar = {
  ...
  //   povecanjeBrzine: function (povecanje) {
  //     for (let i = 0; i < this.trenutnaBrzina.length; i++) {
  //       povecanje += this.trenutnaBrzina;
  //     }
  //     return povecanje;
  //   },
  //   smanjenjeBrzine: function (smanjenje) {},
  //   koci: function () {
